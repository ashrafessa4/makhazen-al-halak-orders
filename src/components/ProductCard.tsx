        ...
        <div className="flex flex-row min-h-[140px] sm:min-h-[150px]">
          ...
          <div className="flex-1 p-3 flex flex-col justify-between min-h-0">
            <div className="space-y-1 flex-shrink-0">
              <CardTitle className="font-bold text-barber-dark text-center leading-tight group-hover:text-barber-blue transition-colors duration-200 line-clamp-2 text-base">
                {product.name}
              </CardTitle>
